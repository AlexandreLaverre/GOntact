...
print(paste("space=",space)) ## e.g. "biological_process
...
info.chr=readLines(paste(pathResults, sp, "/",method,"/expected_values_Ensembl",ensrelease,"_",space,".txt",sep=""))[1:4]
...
expected=read.table(paste(pathResults, sp, "/",method,"/expected_values_Ensembl",ensrelease,"_",space,".txt",sep=""), h=T, stringsAsFactors=F)

pathObserved=paste(pathResults, sp, "/",method,"/",dataset,"/observed_values_Ensembl",ensrelease,"_background", background,"_",space,".txt",sep="")
